...
// If the context timeout occurs before the request finishes, it sets the statusCode to http.StatusGatewayTimeout and
// the error to "gateway timeout: <timeoutDuration>".
