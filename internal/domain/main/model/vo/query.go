...
func (q Query) Projection(projection *configVO.Projection) Query {
	...
	if helper.Equals(projection.Type(), configEnum.ProjectionValueRejection) {
...
func (q Query) Map(mapper *configVO.Mapper) Query {
...
func (q Query) Modify(modify *Modify) Query {
	...
	case configEnum.ModifierActionAdd:
		return q.Add(modify.Key(), newValue)
	case configEnum.ModifierActionApd:
		return q.Append(modify.Key(), newValue)
	case configEnum.ModifierActionSet:
		return q.Set(modify.Key(), newValue)
	case configEnum.ModifierActionRpl:
		return q.Replace(modify.Key(), newValue)
	case configEnum.ModifierActionDel:
		return q.Delete(modify.Key())
	default:
		return q
	}
}
...
func (q Query) projectionAddition(projection *configVO.Projection) Query {
...
func (q Query) projectionRejection(projection *configVO.Projection) Query {
