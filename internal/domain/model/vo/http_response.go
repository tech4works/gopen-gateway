...
// todo:
func (r *HttpResponse) Write(endpoint *Endpoint, httpRequest *HttpRequest, httpResponse *HttpResponse,
) *HttpResponse {
...
func (r *HttpResponse) writeByEndpointConfig(endpoint *Endpoint, statusCode int, header Header,
