...
type BackendResponse struct {
	apply              configEnum.BackendResponseApply
	omit               bool
	omitHeader         bool
	omitBody           bool
	group              string
...
func newBackendResponseForMiddleware() *BackendResponse {
	return &BackendResponse{
		apply: configEnum.BackendResponseApplyLate,
		omit:  true,
	}
}
...
func (b BackendResponse) Apply() configEnum.BackendResponseApply {
	if b.apply.IsEnumValid() {
		return b.apply
	}
	return configEnum.BackendResponseApplyEarly
}
